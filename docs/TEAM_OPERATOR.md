...
- nightly 21:19: league snapshot (standings + matchup + every other team's
  roster, paced with the default 3s `--roster-delay` plus each read's 2s
  settle ≈ 5s/team, ~60-90s total) persisted to `logs/league-report.json`
